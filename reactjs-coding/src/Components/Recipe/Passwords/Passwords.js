    ...
    <div className="password-container">
      <div className="container d-flex flex-column justify-content-center">
        <div className="row d-flex flex-column justify-content-center align-items-center">
          <h1 className="password-heading mb-3 text-secondary fw-light fst-italic text-center">
            Update Password
          </h1>
          <form
          ...
          >
            ...
            <div className="update-password-checkbox-container mb-2">
              <input
                id="up-checkbox"
                type="checkbox"
            ...
            <button
              type="submit"
              className="password-btn btn btn-secondary mt-2 w-100"
            >
              Update
            </button>
          </form>
